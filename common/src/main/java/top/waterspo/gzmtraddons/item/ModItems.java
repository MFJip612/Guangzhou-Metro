...
import static top.waterspo.gzmtraddons.item.ModCreativeTab.GZMTR_TAB;

public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(GzMtr.MOD_ID, Registries.ITEM);
