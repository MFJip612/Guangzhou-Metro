...
public class ModCreativeTab {
    public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(GzMtr.MOD_ID, Registries.CREATIVE_MODE_TAB);

    public static final RegistrySupplier<CreativeModeTab> GZMTR_TAB = TABS.register("gzmtr_tab", () ->
            CreativeTabRegistry.create(
                    Component.translatable("metro.gzmtr"),
